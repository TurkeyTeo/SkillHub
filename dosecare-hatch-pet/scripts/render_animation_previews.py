#!/usr/bin/env python3
"""Render lightweight animated QA previews from extracted DoseCare pet frames."""
...
ROW_DURATIONS = {
    ...
    "happy": [120, 120, 120, 140, 140, 240],
    "sad": [180, 180, 180, 180, 180, 320],
    "greeting": [140, 140, 140, 280],
    "jumping": [140, 140, 140, 140, 280],
    "sick": [180, 180, 180, 180, 180, 320],
    "levelup": [100, 100, 100, 120, 120, 140, 140, 260],
    "eating": [140, 140, 140, 140, 160, 280],
    "sleeping": [320, 240, 240, 320, 240, 420],
}
